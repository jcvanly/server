...
namespace Nos3
{
    ...
    ServerDataPoint::ServerDataPoint(double count) : _not_parsed(false)
    {
    ...
    ServerDataPoint::ServerDataPoint(int16_t spacecraft, const boost::shared_ptr<Sim42DataPoint> dp) : _dp(*dp), _sc(spacecraft), _not_parsed(true)
    {
