#ifndef NOS3_SERVERHARDWAREMODEL_HPP
#define NOS3_SERVERHARDWAREMODEL_HPP
...
** Defines
*/
#define SERVER_SIM_SUCCESS 0
#define SERVER_SIM_ERROR   1
...
namespace Nos3
{
    ...
    class ServerHardwareModel : public SimIHardwareModel
    {
    public:
        /* Constructor and destructor */
        ServerHardwareModel(const boost::property_tree::ptree& config);
        ~ServerHardwareModel(void);

    private:
        /* Private helper methods */
        void create_server_hk(std::vector<uint8_t>& out_data); 
        void create_server_data(std::vector<uint8_t>& out_data); 
        ...
        SimIDataProvider*                                   _server_dp; /* Only needed if the sim has a data provider */
