 ...
 *
 * Purpose:
 * Extra scaffolding functions for the server_app unit test
 *
 * Notes:
...
#ifndef UT_SERVER_APP_H
#define UT_SERVER_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "SERVER_APP_Data_t" typedef.
 */
#include "server_app.h"

/*
 * Allow UT access to the global "SERVER_APP_Data" object.
 */
//extern SERVER_AppData_t SERVER_APP_Data;

#endif /* UT_SERVER_APP_H */
